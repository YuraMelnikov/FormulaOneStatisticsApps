                        ...
                        {mockData.racerResult.map(mockData =>
                            <tr key={mockData.idSeason} className="text-center">
                                ...
                                <td className="text-left">
                                    {mockData.chassies.map(mockDataChassis =>
                                        <p style={{cursor: 'pointer'}} onClick={() => history.push(MANUFACTURER_ROUTE + '/' + mockDataChassis.idChassies)}>{mockDataChassis.chassies}</p>
                                    )}
                                 </td>
