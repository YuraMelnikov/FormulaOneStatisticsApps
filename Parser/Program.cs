...
{
    var grandPrixResultDB = repository.GrandPrixResults
    ...
    {
        grandPrixResultDB[0].FastestLap = result.fastestLap.ToString();
        grandPrixResultDB[0].FastestLap = result.fastestLap;
        grandPrixResultDB[0].FastestLap = result.fastestLap;
        grandPrixResultDB[0].FastestLap = result.fastestLap;
    }
}
